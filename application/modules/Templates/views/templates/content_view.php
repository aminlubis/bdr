...
<html lang="en">
  ...
  <body class="no-skin">
    ...
    <div id="navbar" class="navbar navbar-default" style="background: #3029f0">
      ...
      <div class="navbar-container" id="navbar-container">
        ...
        <div class="navbar-header pull-left">
          ...
          <a href="#" class="navbar-brand">
            <small>
              <img src="<?php echo PATH_IMG_DEFAULT.$app->app_logo?>" height="45px" style="margin: -54px -23px -56px">
