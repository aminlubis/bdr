...
<html>
  <head>
    ...
    <meta name="BD&R" content="yes">
    <meta name="BD&R" content="yes">
    <meta name="BD&R" content="default">
    ...
    <!-- <link rel="shortcut icon" href="<?php echo base_url()?>assets/images/logo_bdr.jpg"> -->
    ...
    <div class="login-wrapper ">
      ...
      <div class="login-container bg-white">
        <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
          ...
          <small style="padding-top:-30px !important; font-size: 14px"><?php echo COMPANY; ?></small>
          ...
          <form id="form-login" class="p-t-15" method="POST" role="form" action="<?php echo base_url().'login/process'?>" autocomplete="off">
            ...
            <div class="row">
              ...
              <div class="col-md-6 text-right">
                <a href="#" class="text-info small">Need help?<br>Please call Administrator <br><i class="fa fa-phone"></i> ext. -</a>
              </div>
            </div>
            <!-- END Form Control-->
